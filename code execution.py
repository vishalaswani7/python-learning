...
# 3 conversion of string(text) into integer : whenever we use input() python stores the data as string
age = int(input("what is your age"))
#now if the user enter 18 it will take it as integer and not string and we can preform calculations
age = int(input("what is your age"))
print(age + 5 )
...
# everything after a hash (#) is considered as comment and is ignored by python